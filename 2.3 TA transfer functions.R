...
tas_transfer_probit_results = data.frame(white_probit_out = white_probit_out$coefficients,
...
tas_transfer_amount_results = data.frame(white_transfer_out = white_transfer_out$coefficients,
...
write.csv(tas_transfer_probit_results, "../data/tas_transfer_probit_results.csv")
write.csv(tas_transfer_amount_results, "../data/tas_transfer_amount_results.csv")
